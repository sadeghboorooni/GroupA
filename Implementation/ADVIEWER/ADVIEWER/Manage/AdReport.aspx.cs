...
namespace ADVIEWER.Manage
{
    public partial class AdReport : System.Web.UI.Page
    {
        ...
        private void LoadStaredGridView()
        {
            ...
            staredAdvsGridView.DataSource = MemberFunctions.AdReportStar((StartDateY.Text.ToString() + StartDateM.Text.ToString() + StartDateD.Text.ToString()), (EndDateY.Text.ToString() + EndDateM.Text.ToString() + EndDateD.Text.ToString()));
